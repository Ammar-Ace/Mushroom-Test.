...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.feature-card, .product-card, .about-text, .contact-info');
...
console.log('%c🍄 Welcome to Mushroom Coffee Co! ☕', 'color: #8B4513; font-size: 20px; font-weight: bold;');
console.log('%cThanks for checking out our code!', 'color: #666; font-size: 14px;');
